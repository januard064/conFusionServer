...
// API for dishes/:dishId/comments
...
// API for dishes/dishId/comments/commentId
...
.post(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => {
    res.statusCode = 403
    res.end(`Post operation not supproting in /dishes/${req.params.dishId}/comments/${req.params.commentId} `)
})
.put(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => {
    Dishes.findById(req.params.dishId)
    .then((dish) => {
